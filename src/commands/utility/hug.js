...
module.exports = {
    ...
    async execute(interaction) {
        const hugger = interaction.user.displayName;
        const hugged = interaction.options.getUser('member').displayName;
        ...
        const embed = new EmbedBuilder().setTitle(`${hugger} gave ${hugged} a hug!`).setColor("Blue").setImage(`${gif_list[rng]}`)
        console.log(embed)
